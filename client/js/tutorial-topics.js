        ...
        material: {
            ...
            steps: [
                ...
                },
                {
                    icon: '🔮',
                    title: '使い道①：オーブ作成',
                    body: '「オーブ工房」タブの「素材からオーブを作る」では、素材を最大5つ選んでオーブに変換できます。\n選んだ素材の平均レア度が高いほど、高ティアのオーブができやすくなります。'
                },
                {
                    icon: '🗡️',
                    title: '使い道②：武器のボーナス素材',
        ...
        orb: {
            ...
            steps: [
                ...
                },
                {
                    icon: '📦',
                    title: '入手方法③：素材から作成する',
                    body: '倒したモンスターから入手した「素材」を使ってオーブを作ることもできます。\n「オーブ工房」タブを開き、「素材からオーブを作る」で素材を最大5つ選んで「オーブを作成」を実行しましょう。\n選んだ素材のレア度が高いほど、高ティアのオーブができやすくなります。'
                },
                {
                    icon: '✨',
                    title: 'オーブ合成でアップグレード',
                    body: '「オーブ工房」タブの「オーブ合成」では、同じティアのオーブを複数消費して、より上位のオーブに合成できます。\n・ティア1を5個 → ティア2が1個\n・ティア2を5個 → ティア3が1個\n・ティア3を10個 → ティア4が1個\n低ティアのオーブが余ったら、合成して上位を目指しましょう。'
                },
                {
                    icon: '📊',
                    title: 'ステータスボーナスの目安',
        ...
        online: {
            ...
            steps: [
                ...
                },
                {
                    icon: '🤖',
                    title: 'ボットバトル',
                    body: '対戦相手のモンスターを選んで、一人でいつでも練習できます。\nモンスターの強さ（合計ステータス）は自分のステータスに関係なく一定です。\n「おまかせ」を選ぶと、自分の強さに近いモンスターとランダムに対戦します。'
                },
                {
                    icon: '🎉',
                    title: 'パーティ',
