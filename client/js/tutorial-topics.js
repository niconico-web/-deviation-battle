    ...
    const TOPICS = {
        ...
        material: {
            ...
            steps: [
                ...
                {
                    icon: '✨',
                    title: '使い道③：オリジナルスキル作成',
                    body: '一部の素材は「オリジナルスキル作成」の「素材で作成」で使うことができ、最大3つまで選んで組み合わせられます。\nダメージアップ、HP回復、敵へのデバフ、毒付与など、素材ごとに決まった効果を持つスキルを作成できます。'
                }
            ]
        },
        orb: {
        ...
        skill: {
            ...
            steps: [
                ...
                },
                {
                    icon: '📝',
                    title: 'オリジナルスキル作成',
                    body: '「カスタムスキル」タブでは、2つの方法でオリジナルスキルを作成できます。\n「説明文で作成」：名前と内容を自由に書くと、AIが解析して効果を生成します（100コイン消費）。\n「素材で作成」：素材を最大3つ選ぶだけで、その効果を組み合わせたスキルになります（素材を消費）。'
                }
            ]
        },
        study: {
