...
const MATERIAL_DATA = {
    goblin_fang: { id: 'goblin_fang', name: '?S?u???????', description: '?S?u?????L???O?????????????B??????????f??????g???????B' },
    goblin_hide: { id: 'goblin_hide', name: '?S?u???????', description: '?S?u?????L???O?????????????v????B?h????????f??????g???????B' },
    slime_jelly: { id: 'slime_jelly', name: '?X???C???[???[', description: '?X???C???N?C?[?????????????S?t?B?I?[?u??Z??????B' },
    slime_core: { id: 'slime_core', name: '?X???C???R?A', description: '?X???C???N?C?[????j?B?????I?[?u??G?}?????B' },
    dragon_scale: { id: 'dragon_scale', name: '?h???S?????', description: '?t???C???h???S?????????????d????B??????h????f??B' },
    dragon_heart: { id: 'dragon_heart', name: '?h???S????S??', description: '?t???C???h???S?????|??????B?????I?[?u??G?}?B' },
};
