...
function getRecommendedStats(difficulty) {
    ...
    // ナイトメアは総ステータス99999999（約1億）レベルを想定。
    const stats = {
        'easy': '総ステータス 4500以上',
        'normal': '総ステータス 15000以上',
        'hard': '総ステータス 50000以上',
        'very_hard': '総ステータス 200000以上',
        'nightmare': '総ステータス 99999999以上'
    };
